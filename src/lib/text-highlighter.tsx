...
export class TextHighlighter {
  public static highlight(text: string, search: string, matchedCssStyleClass: string): React.ReactNode {
  ...
  public static highlight2(text: string, start: number, end: number, matchedCssStyleClass: string): React.ReactNode {
    if (start > -1) {
