...
export const MODELS: ModelProps[] = [
  ...
  },
  {
    ...
    free: false,
    autoSelectable: true,
    description: "Qwen QwQ 32B, efficient reasoning model.",
  },
  {
    provider: PROVIDER_NEBIUS,
    ...
    free: false,
    autoSelectable: true,
    description: "Meta Llama 3.3 70B, instruction-tuned model for general tasks.",
  },
  {
    provider: PROVIDER_NEBIUS,
    ...
    free: false,
    autoSelectable: true,
    description: "Meta Llama 3.1 405B, largest Llama model for complex reasoning.",
  },
  {
    provider: PROVIDER_NEBIUS,
