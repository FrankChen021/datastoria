...
2. **Available capabilities**:
  ...
  - **Root Cause Analysis**: For requests like "why is X happening", "what caused X", "root cause", or "explain" about cluster behavior, load \`cluster-diagnostics\`. The skill handles detection (\`collect_cluster_status\`) and RCA evidence collection (\`collect_rca_evidence\`). Do NOT attempt ad-hoc SQL for RCA without the skill.
