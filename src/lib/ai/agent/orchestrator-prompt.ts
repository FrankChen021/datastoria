...
2. **Available capabilities**:
  ...
  - **Cluster Health Diagnostics**: Load the \`cluster-health\` skill for health checks, replication lag, disk usage, memory pressure, parts explosion, mutations, merges, errors, and connections.
