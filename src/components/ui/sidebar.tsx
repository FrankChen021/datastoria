...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "ml-2 mt-1 flex min-w-0 translate-x-px flex-col gap-0.5 border-l-2 border-sidebar-border pl-3 py-1",
      "group-data-[collapsible=icon]:hidden",
      className
    )}
    {...props}
