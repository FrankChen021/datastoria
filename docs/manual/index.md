...
head:
  - - meta
    - name: keywords
      content: DataStoria manual, ClickHouse documentation, AI SQL guide, database management tutorial, ClickHouse console guide, natural language SQL, query optimization guide
---
